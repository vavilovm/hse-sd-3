...
### **LsCommand**
Выводит в `stdout` названия файлов внутри переданной директории или внутри текущей директории, если аргументов нет. Ожидает 1 или 0 аргументов.

`execute(String input)` игнорирует `input`

### **CdCommand**
Меняет текущую директорию на переданную в аргументе или на `HOME`, если аргументов нет.
